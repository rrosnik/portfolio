...
export const projects: PortfolioProject[] = [
  {
    label: "LCCA — Building Life-Cycle Cost Assessment Platform",
    description:
      "A full-stack web application built for the National Research Council (NRC) in Canada that lets project teams evaluate the true lifetime cost of a building — not just its upfront construction price — and compare design alternatives before committing to one. ",
    imageUrl: "/images/projects/lcca/lcca-8.png",
    images: [
      "/images/projects/lcca/lcca-1.png",
      "/images/projects/lcca/lcca-2.png",
      "/images/projects/lcca/lcca-3.png",
      "/images/projects/lcca/lcca-4.png",
      "/images/projects/lcca/lcca-5.png",
      "/images/projects/lcca/lcca-6.png",
      "/images/projects/lcca/lcca-7.png",
      "/images/projects/lcca/lcca-8.png",
    ],
    skills: [
      "git",
      "nextjs",
    ...
    accessNote:
      "Built for the National Research Council Canada — this is closed-source, NRC-internal work, so the source code and a live demo aren't publicly available.",
  },
  {
    label: "NBLA — BIM-Based Life-Cycle Assessment & Cost Platform",
    description:
      "A full-stack, multi-tenant platform that ingests IFC building models and turns them into actionable sustainability and cost data — automated IFC-to-UniFormat/MasterFormat element mapping, IDS-based model validation, Global Warming Potential (GWP) and Life-Cycle Cost (LCC) analysis, and bill-of-materials export, all organized under an org → workspace → project hierarchy with role-based access.",
    imageUrl: "/images/projects/lca/lca-17.png",
    images: [
      "/images/projects/lca/lca-1.png",
      "/images/projects/lca/lca-2.png",
      "/images/projects/lca/lca-3.png",
      "/images/projects/lca/lca-4.png",
      "/images/projects/lca/lca-5.png",
      "/images/projects/lca/lca-6.png",
      "/images/projects/lca/lca-7.png",
      "/images/projects/lca/lca-8.png",
      "/images/projects/lca/lca-9.png",
      "/images/projects/lca/lca-10.png",
      "/images/projects/lca/lca-11.png",
      "/images/projects/lca/lca-12.png",
      "/images/projects/lca/lca-13.png",
      "/images/projects/lca/lca-14.png",
      "/images/projects/lca/lca-15.png",
      "/images/projects/lca/lca-16.png",
      "/images/projects/lca/lca-17.png",
    ],
    skills: [
      "git",
      "nextjs",
    ...
    category: "Full Stack / BIM & Sustainability",
    accessNote:
      "A personal rewrite (in Next.js) of a private prior project — still under active development, so the source code and a live demo aren't publicly available yet.",
  },
  {
